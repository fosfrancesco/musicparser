...
def main():
    ...
    parser.add_argument('--pos_enc', type= str, default="absolute", help="'absolute', or 'relative'" )
    ...
    datamodule.setup()
    # pretrain with the big dataset
    trainer.fit(model, train_dataloaders=datamodule.pre_train_dataloader(), val_dataloaders=datamodule.val_dataloader())
